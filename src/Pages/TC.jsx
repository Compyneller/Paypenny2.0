      ...
      <div className="text-light" style={{ background: "#0F4A8A" }}>
        <div className="container py-5">
          ...
          <ol>
            ...
            <li>
              <h5>PRE-AUTHORIZED DEBIT AUTHORIZATION</h5>
              <ul>
                <li>
            ...
            <li>
              <h5>ERROR RESOLUTION AND REFUNDS</h5>
            </li>
            <ul>
              <li>
            ...
            <li>
              <h5>INTELLECTUAL PROPERTY ACKNOWLEDGEMENT</h5>
              <ul>
                <li>
